...
public class DriverTracking extends FragmentActivity implements OnMapReadyCallback,GoogleApiClient.OnConnectionFailedListener,GoogleApiClient.ConnectionCallbacks,LocationListener,
    ...
    public static double rider_lat,rider_lng;
    ...
    private void getDirection() {
        ...
        mService.getPath("driving", "less_driving", mlastlocation.getLatitude() + "," + mlastlocation.getLongitude(), rider_lat + "," + rider_lng, getResources().getString(R.string.google_direction_api))
    ...
    public static String getDirectionsUrl() {
        ...
        // Sensor enabled
        String api_key="AIzaSyBcbLAMZ8lY23ch55Oq5xuGbe58w7SRKn8";
