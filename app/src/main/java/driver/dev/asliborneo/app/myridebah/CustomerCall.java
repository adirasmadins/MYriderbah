...
public class CustomerCall extends AppCompatActivity {
   public TextView txt_time, txt_distance, txt_Address;
    ...
    private void getDirection(double lat,double lng) {
        ...
        Call<Directions> call=service.getPath("driving","less_driving" ,mlastlocation.getLatitude()+","+mlastlocation.getLongitude(),lat+","+lng,"AIzaSyCw0musjvyG7sFkZf0QeVCCeUPK3TEztIE");
