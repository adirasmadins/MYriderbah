...
public class Welcome extends FragmentActivity
        ...
        LocationListener,OnMapLongClickListener, OnCameraIdleListener, OnMapClickListener {
    ...
    private void getDirection() {
        ...
        try {
            ...
            requestApi = "https://maps.googleapis.com/maps/api/directions/json?origin=disneyland&destination=Universal+Studios+Hollywood&" +
                    "mode=driving&" +
    ...
    private void stopLocationUpdates()
    {
        ...
        LocationServices.FusedLocationApi.removeLocationUpdates(mGoogleApiClient,this); //careful, 2rd param was "this"
    }
    ...
    public void onMapReady(GoogleMap googleMap) {
        ...
        mMap.moveCamera(CameraUpdateFactory.newLatLngZoom(new LatLng(5.9804, 116.0735), 10));
